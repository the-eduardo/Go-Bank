...
func TestTransferTxDeadLock(t *testing.T) {
	...
	fmt.Println(">> after:", updatedAccount1.Balance, updatedAccount2.Balance)
	require.Equal(t, account1.Balance, updatedAccount1.Balance, "Final balance is not equal")
	require.Equal(t, account2.Balance, updatedAccount2.Balance, "Final balance is not equal")
}
